...
declare class Bluebird<R> implements Bluebird.Thenable<R>, Bluebird.Inspection<R> {
   ...
   * Alias `.caught();` for compatibility with earlier ECMAScript version.
   */
  catch(predicate: {}, onReject: (error: any) => R | Bluebird.Thenable<R> | void | Bluebird.Thenable<void>): Bluebird<R>;
  catch<U>(predicate: {}, onReject: (error: any) => U | Bluebird.Thenable<U>): Bluebird<U | R>;
